...
public class ADXL345 implements MultiAxisGyro {
	...
	public ADXL345() throws IOException, UnsupportedBusNumberException {
		I2CBus bus = I2CFactory.getInstance(I2CBus.BUS_1);
		device = bus.getDevice(ADXL345_ADDRESS);
		this.init(this.X, Gyroscope.GET_RAW_VALUE_TRIGGER_READ);

		msg = new MsgTransformer();
	}
	...
	public int[] getVector() throws IOException, InterruptedException {
		...
		String sx = toString(this.X.getRawValue(), 7);
		String sy = toString(this.Y.getRawValue(), 7);
		String sz = toString(this.Z.getRawValue(), 7);

		this.setVector(this.X.getRawValue(), this.Y.getRawValue(), this.Z.getRawValue());
